                ...
                <div class="upload" :key="refreshKey">
                  <div class="upload-browser">
                    ...
                    <label for="contractImage"
                      ...
                      {{
                        $t("components.confirmUser.chooseContractImage")
                      }}</label
                    >
                    <DxCheckBox
                      id="contractDelete"
                  ...
                  <div class="upload-browser">
                    ...
                    <label for="identityImage"
                      ><i class="far fa-file-upload"></i>
                      {{
                        $t("components.confirmUser.chooseIdentityImage")
                      }}</label
                    >
                    <DxCheckBox
                      id="identityDelete"
...
export default {
  ...
  methods: {
    ...
    show({ user }) {
      ...
      this.popup.show();
      setTimeout(
        () => this.accordion.option("selectedIndex", user.level == 4 ? 0 : 1),
        0
      );
    ...
    onSubmit() {
      this.$bus.emit("checkPin", async () => {
        ...
        formData.append("isContractDelete", this.formData.isContractDelete);
        formData.append("isIdentityDelete", this.formData.isIdentityDelete);
        for (var i = 0; i < this.$refs.contractImage.files.length; i++) {
        ...
        for (var i = 0; i < this.$refs.identityImage.files.length; i++) {
          let file = await this.$mf.resizeImage({
