          ...
          <template #depositTemplate>
            ...
            >
              <DxItem
                ...
                :label="{
                  text: $t('components.transactionFinbook.money'),
                }"
              />
              <DxItem
                ...
                :label="{
                  text: $t('components.transactionFinbook.content'),
                }"
              />
              <DxItem
                name="depositSubmit"
          ...
          <template #transferTemplate>
            ...
            >
              <DxItem
                ...
                :label="{
                  text: $t('components.transactionFinbook.receiverId'),
                }"
              />
              <DxItem
...
export default {
        ...
        receiverId: [
          {
            type: "required",
            message:
              this.$t("components.transactionFinbook.receiverId") +
              this.$mt.validations.required,
          },
        ],
      },
  ...
  methods: {
    ...mapActions("Admin.finbooks", ["updateBalance", "getFinbooksName"]),
    show(finbook) {
      ...
      setTimeout(
        () =>
          this.$refs[`${this.formData.type}Form`].instance
            .getEditor(
              `${this.formData.type}.${
                this.formData.type == "transfer" ? "receiverId" : "money"
              }`
            )
            .focus(),
        500
