            ...
            <div class="main">
                <div class="terms">
                    ...
                    <div>
                        ...
                        {{ $filters.formatDate(state.contract.withdrawn_at) }}
                    </div>
                    <div>
                        - {{ $t("models.contract.duration") }}:
                        {{ state.contract.duration }}
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        {{ $filters.currency(state.contract.interest) }}
                        ({{ $filters.readCurrency(state.contract.interest) }})
                    </div>
                </div>
                <div class="terms">
                    ...
                    <div>
                        ...
                        {{
                            $filters.currency(
                                contract.principal + contract.interest
                            )
                        }}
                        (
                        {{
                            $filters.readCurrency(
                                contract.principal + contract.interest
                            )
                        }}).
                    </div>
