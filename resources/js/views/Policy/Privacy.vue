<template>
  <section class="privacy">
    ...
    <ul class="title">
      ...
      <ul>
        <li>
          ...
          {{ $appName }} nghiêm túc thực hiện trách nhiệm của mình liên quan đến
          ...
          {{ $appName }} (“Hệ thống”). Chúng tôi nhận biết tầm quan trọng của dữ
        ...
        <li>
          ...
          {{ $appName }}, quý khách xác nhận và đồng ý rằng quý khách chấp nhận
      ...
      <ul>
        <li>
          <div>
            ...
            <div>a. khi quý khách đăng ký mở một tài khoản với chúng tôi;</div>
            <div>
    ...
    <ul class="title" :style="{ counterReset: 'index 2' }">
      <li data-suffix=".">{{ $appName }} sẽ thu thập những dữ liệu gì?</li>
      <ul>
        <li>
          <div>
            <div>
              Dữ liệu cá nhân mà {{ $appName }} có thể thu thập bao gồm:
            </div>
            <div>a. họ và tên;</div>
            <div>b. giới tính;</div>
            <div>c. ngày sinh;</div>
            ...
            <div>h. tài khoản ngân hàng và thông tin thanh toán;</div>
            <div>
              i. bất kỳ thông tin nào khác về người dùng khi người dùng đăng
              nhập để sử dụng Dịch Vụ;
            </div>
            <div>j. dữ liệu tổng hợp về nội dung người dùng sử dụng.</div>
          </div>
        </li>
        <li>
      ...
      <ul>
        <li>
          <div>
            ...
            <div>a. để cho phép chúng tôi liên lạc với quý khách;</div>
            <div>a. để quản lý, điều hành dịch vụ quý khách sử dụng;</div>
            <div>
    ...
    <ul class="title" :style="{ counterReset: 'index 4' }">
      <li data-suffix=".">
        {{ $appName }} bảo vệ và lưu trữ thông tin khách hàng bằng cách nào?
      </li>
      <ul>
        <li>
