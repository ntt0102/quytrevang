            ...
            :toolbarItems="[
                {
                    ...
                    options: {
                        text: $t('buttons.save'),
                        onClick: () =>
                            form.getButton('submit').element().click(),
                    },
                },
                {
                    toolbar: 'bottom',
                    ...
                    >
                        ...
                        >
                            <DxItem
                                ...
                                :validation-rules="
                                    validationRules.bankAccount.bankName
                                "
                            ...
                            <DxItem
                                ...
                                :validation-rules="
                                    validationRules.bankAccount.accountNumber
                                "
                                :label="{
                            ...
                            <DxItem
                                ...
                                :validation-rules="
                                    validationRules.bankAccount.accountName
                                "
