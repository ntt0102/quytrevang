            ...
            :items="[
              {
                ...
                options: {
                  ...
                  type: 'default',
                  icon: isRowRestored(data.key) ? 'undo' : 'repeat',
                  hint: $t('admin.users.buttons.revert'),
                  text: $t('admin.users.buttons.revert'),
                  onClick: () => {
                    if (isRowRestored(data.key)) unrestore(data.key);
                    else dataGrid.cellValue(data.rowIndex, 'deleted_at', null);
              ...
              },
              {
                ...
                options: {
                  type: 'default',
                  icon: isRowDeleted(data.key) ? 'undo' : 'clearsquare',
