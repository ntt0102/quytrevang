            ...
            :items="[
              {
                ...
                options: {
                  ...
                  hint: $t('admin.finbooks.createTransaction'),
                  text: $t('admin.finbooks.createTransaction'),
                  onClick: () => $refs.transactionFinbookPopup.show(data.data),
                },
              },
              {
                ...
                options: {
                  ...
                  onClick: () => dataGrid.deleteRow(data.rowIndex),
                },
              },
            ]"
          />
...
import adminFinbooksStore from "../../store/modules/Admin/Finbooks";
        ...
        name: [
          {
            type: "required",
            message:
              this.$t("admin.finbooks.name") + this.$mt.validations.required,
          },
        ],
        balance: [
          {
            type: "required",
            message:
              this.$t("admin.finbooks.balance") + this.$mt.validations.required,
          },
        ],
        lastTransaction: [
          {
        ...
        display: [
          {
            type: "required",
            message:
              this.$t("admin.finbooks.display") + this.$mt.validations.required,
          },
        ],
      },
    };
