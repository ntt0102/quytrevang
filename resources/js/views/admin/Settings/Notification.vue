<template>
  <div>
    <form class="setting-notification-tab" @submit.prevent="onSubmit">
      <DxForm
        ref="form"
        :form-data="formData"
      ...
      >
        <DxItem item-type="group">
          <DxItem
            ...
            :label="{ text: $t('admin.settings.notification.receiver') }"
          />
          <DxItem
            data-field="title"
            :validation-rules="validationRules.title"
            :label="{
              text: $t('admin.settings.notification.notificationTitle'),
            }"
          />
          <DxItem
            data-field="body"
            :validation-rules="validationRules.body"
            :label="{ text: $t('admin.settings.notification.body') }"
          />
          <DxItem
            data-field="image"
            editor-type="dxTextBox"
                  ...
                  options: {
                    ...
                    onClick: () =>
                      $refs.pickImagePopup.show({
                        ...
                        callback: (url) => (formData.image = url),
                      }),
                  },
                  name: 'pickImage',
                  location: 'after',
            ...
            :label="{ text: $t('admin.settings.notification.image') }"
          />
        </DxItem>
        <DxItem
          item-type="group"
          :caption="$t('admin.settings.notification.action.title')"
        ...
        title: [
          {
            type: "required",
            message:
              this.$t("admin.settings.notification.notificationTitle") +
              this.$mt.validations.required,
          },
        ],
        body: [
