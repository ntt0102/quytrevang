  ...
  <div class="trades-page">
    ...
    <div class="content-block dx-card responsive-paddings">
        ...
        :items="[
          ...
          },
          {
            ...
            options: {
              ...
              onClick: () => $refs.pickImagePopup.show({ clientPath: 'vps' }),
            },
          },
          {
            visible: permissions.includes('trades@edit'),
      ...
      <DxChart
        ...
        :series="[
          {
            name: $t('admin.trades.revenueSum'),
            tag: 'revenue',
            valueField: 'revenue',
            axis: 'money',
            type: 'stackedbar',
      ...
      >
        <template #markerTemplate="{ data }">
          <g>
            <g v-if="data.series.type === 'spline'">
              <rect
                :x="-10"
                :y="-1.5"
                :width="30"
...
export default {
  ...
  methods: {
    ...
    customizePoint({ value, series }) {
      ...
      else return { color: series.color, hoverStyle: { color: series.color } };
    },
    ...
    onPointClick({ target }) {
      let referenceTime =
        this.getReferenceTime() === target.argument ? null : target.argument;
