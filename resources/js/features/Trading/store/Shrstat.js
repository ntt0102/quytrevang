...
const actions = {
    getData({ commit, dispatch, getters, state, rootGetters }, param) {
        return new Promise((resolve, reject) => {
            axios
                .post("trading/shrstat", null, { noLoading: true })
                .then((response) => {
    ...
    getSummary({ commit, dispatch, getters, state, rootGetters }, param) {
        return new Promise((resolve, reject) => {
            axios.post("trading/shrstat/summary", null).then((response) => {
    ...
    getOpening({ commit, dispatch, getters, state, rootGetters }, param) {
        return new Promise((resolve, reject) => {
            axios.post("trading/shrstat/opening", null).then((response) => {
    ...
    save({ commit, dispatch, getters, state, rootGetters }, param) {
        return new Promise((resolve, reject) => {
            axios
                .post("trading/shrstat/save", { changes: param.changes })
                .then((response) => {
                    resolve();
                    dispatch("getData");
                    dispatch("getOpening");
