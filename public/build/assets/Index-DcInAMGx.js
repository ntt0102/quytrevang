<<<<<<< HEAD
import{D as S}from"./chart-COwcNzwh.js";import A from"./OpeningSummary-BFIO5XmU.js";import z from"./Summary-BIerRwAq.js";import F from"./TrackStatisticPopup-BtwqDSTM.js";import{u as D,a as _,r as B,c as L,K as V,b as d,e as o,d as h,f as R,g as E,F as q,h as M,j as N,k as b,m as j,o as u}from"./app-z_pbts3p.js";import"./m_base_chart-BBwZJOd2.js";const G={class:"trades-page content-block dx-card responsive-paddings"},W={key:0},K=["fill"],O={key:1},U=["fill"],ee={__name:"Index",setup(Z){const f=M(),k=N(),{t:n}=D(),g=b("bus"),r=b("filters");let p={targetThreshold:{profit:0,rr:1,winrate:50}};const s=_({profit:!0,rr:!1,winrate:!1,accProfit:!0}),l=B(null),c=L(()=>f.state.tradingShrstat.charts);f.dispatch("tradingShrstat/getProfitChart",k.query.period??"day"),g.on("toggleMenu",()=>{setTimeout(()=>l.value.instance.render(),300)}),V(()=>g.off("toggleMenu"));function w(e){f.dispatch("tradingShrstat/getProfitChart",e)}function $({value:e,series:t}){switch(t.tag){case"profit":if(e<=p.targetThreshold.profit)return{color:"FireBrick",hoverStyle:{color:"FireBrick"}};break;case"rr":if(e>p.targetThreshold.rr)return{color:"Aqua",hoverStyle:{color:"Aqua"}};break;case"winrate":if(e>p.targetThreshold.winrate)return{color:"Fuchsia",hoverStyle:{color:"Fuchsia"}};break}}function P({value:e}){return r.shorten(e)}function y(e){let t=e.point.data.accProfit,i=m();if(i!==null){let a=c.value.data.find(C=>C.date===i).accProfit;t=t-a}return{html:`<div class='trade-chart-tooltip'>
=======
<<<<<<<< HEAD:public/build/assets/Index-DcInAMGx.js
import{D as S}from"./chart-COwcNzwh.js";import A from"./OpeningSummary-BFIO5XmU.js";import z from"./Summary-BIerRwAq.js";import F from"./TrackStatisticPopup-BtwqDSTM.js";import{u as D,a as _,r as B,c as L,K as V,b as d,e as o,d as h,f as R,g as E,F as q,h as M,j as N,k as b,m as j,o as u}from"./app-z_pbts3p.js";import"./m_base_chart-BBwZJOd2.js";const G={class:"trades-page content-block dx-card responsive-paddings"},W={key:0},K=["fill"],O={key:1},U=["fill"],ee={__name:"Index",setup(Z){const f=M(),k=N(),{t:n}=D(),g=b("bus"),r=b("filters");let p={targetThreshold:{profit:0,rr:1,winrate:50}};const s=_({profit:!0,rr:!1,winrate:!1,accProfit:!0}),l=B(null),c=L(()=>f.state.tradingShrstat.charts);f.dispatch("tradingShrstat/getProfitChart",k.query.period??"day"),g.on("toggleMenu",()=>{setTimeout(()=>l.value.instance.render(),300)}),V(()=>g.off("toggleMenu"));function w(e){f.dispatch("tradingShrstat/getProfitChart",e)}function $({value:e,series:t}){switch(t.tag){case"profit":if(e<=p.targetThreshold.profit)return{color:"FireBrick",hoverStyle:{color:"FireBrick"}};break;case"rr":if(e>p.targetThreshold.rr)return{color:"Aqua",hoverStyle:{color:"Aqua"}};break;case"winrate":if(e>p.targetThreshold.winrate)return{color:"Fuchsia",hoverStyle:{color:"Fuchsia"}};break}}function P({value:e}){return r.shorten(e)}function y(e){let t=e.point.data.accProfit,i=m();if(i!==null){let a=c.value.data.find(C=>C.date===i).accProfit;t=t-a}return{html:`<div class='trade-chart-tooltip'>
========
import{D as S}from"./chart-C_tTHocF.js";import A from"./OpeningSummary-CnNVyTVu.js";import z from"./Summary-CkMNdnuj.js";import F from"./TrackStatisticPopup-Dn2m6B47.js";import{u as D,a as _,r as B,c as L,K as V,b as d,e as o,d as h,f as R,g as E,F as q,h as M,j as N,k as b,m as j,o as u}from"./app-CLkLlxM6.js";import"./m_base_chart-EQzuojUk.js";const G={class:"trades-page content-block dx-card responsive-paddings"},W={key:0},K=["fill"],O={key:1},U=["fill"],ee={__name:"Index",setup(Z){const f=M(),k=N(),{t:n}=D(),g=b("bus"),r=b("filters");let p={targetThreshold:{profit:0,rr:1,winrate:50}};const s=_({profit:!0,rr:!1,winrate:!1,accProfit:!0}),l=B(null),c=L(()=>f.state.tradingShrstat.charts);f.dispatch("tradingShrstat/getProfitChart",k.query.period??"day"),g.on("toggleMenu",()=>{setTimeout(()=>l.value.instance.render(),300)}),V(()=>g.off("toggleMenu"));function w(e){f.dispatch("tradingShrstat/getProfitChart",e)}function $({value:e,series:t}){switch(t.tag){case"profit":if(e<=p.targetThreshold.profit)return{color:"FireBrick",hoverStyle:{color:"FireBrick"}};break;case"rr":if(e>p.targetThreshold.rr)return{color:"Aqua",hoverStyle:{color:"Aqua"}};break;case"winrate":if(e>p.targetThreshold.winrate)return{color:"Fuchsia",hoverStyle:{color:"Fuchsia"}};break}}function P({value:e}){return r.shorten(e)}function y(e){let t=e.point.data.accProfit,i=m();if(i!==null){let a=c.value.data.find(C=>C.date===i).accProfit;t=t-a}return{html:`<div class='trade-chart-tooltip'>
>>>>>>>> parent of 330ff6150 (ps fix):public/build/assets/Index-bKsTItUb.js
