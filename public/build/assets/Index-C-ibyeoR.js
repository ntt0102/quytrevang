<<<<<<<< HEAD:public/build/assets/Index-D7WLGzXz.js
import{D as S}from"./chart-seRPlN9j.js";import A from"./OpeningSummary-DmtuC_-q.js";import z from"./Summary-nobNV-no.js";import F from"./TrackStatisticPopup-Dz1mlT6B.js";import{u as D,a as _,r as B,c as L,H as V,b as d,e as o,d as h,f as R,g as E,F as q,h as M,j as N,k as b,m as j,o as u}from"./app-BMdw5pp6.js";import"./m_base_chart-CpF3Hk81.js";/* empty css            */const G={class:"trades-page content-block dx-card responsive-paddings"},W={key:0},H=["fill"],O={key:1},U=["fill"],te={__name:"Index",setup(Z){const f=M(),k=N(),{t:n}=D(),g=b("bus"),r=b("filters");let p={targetThreshold:{profit:0,rr:1,winrate:50}};const s=_({profit:!0,rr:!1,winrate:!1,accProfit:!0}),l=B(null),c=L(()=>f.state.tradingShrstat.charts);f.dispatch("tradingShrstat/getProfitChart",k.query.period??"day"),g.on("toggleMenu",()=>{setTimeout(()=>l.value.instance.render(),300)}),V(()=>g.off("toggleMenu"));function w(e){f.dispatch("tradingShrstat/getProfitChart",e)}function $({value:e,series:t}){switch(t.tag){case"profit":if(e<=p.targetThreshold.profit)return{color:"FireBrick",hoverStyle:{color:"FireBrick"}};break;case"rr":if(e>p.targetThreshold.rr)return{color:"Aqua",hoverStyle:{color:"Aqua"}};break;case"winrate":if(e>p.targetThreshold.winrate)return{color:"Fuchsia",hoverStyle:{color:"Fuchsia"}};break}}function P({value:e}){return r.shorten(e)}function y(e){let t=e.point.data.accProfit,i=m();if(i!==null){let a=c.value.data.find(C=>C.date===i).accProfit;t=t-a}return{html:`<div class='trade-chart-tooltip'>
========
import{D as S}from"./chart-gX5_bKLV.js";import A from"./OpeningSummary-zuBTQujF.js";import z from"./Summary-D-KtXGU2.js";import F from"./TrackStatisticPopup-BKJvFr2F.js";import{u as D,a as _,r as B,c as L,H as V,b as d,e as o,d as h,f as R,g as E,F as q,h as M,j as N,k as b,m as j,o as u}from"./app-B_ZqL3KA.js";import"./m_base_chart-DvD8HAgF.js";/* empty css            */const G={class:"trades-page content-block dx-card responsive-paddings"},W={key:0},H=["fill"],O={key:1},U=["fill"],te={__name:"Index",setup(Z){const f=M(),k=N(),{t:n}=D(),g=b("bus"),r=b("filters");let p={targetThreshold:{profit:0,rr:1,winrate:50}};const s=_({profit:!0,rr:!1,winrate:!1,accProfit:!0}),l=B(null),c=L(()=>f.state.tradingShrstat.charts);f.dispatch("tradingShrstat/getProfitChart",k.query.period??"day"),g.on("toggleMenu",()=>{setTimeout(()=>l.value.instance.render(),300)}),V(()=>g.off("toggleMenu"));function w(e){f.dispatch("tradingShrstat/getProfitChart",e)}function $({value:e,series:t}){switch(t.tag){case"profit":if(e<=p.targetThreshold.profit)return{color:"FireBrick",hoverStyle:{color:"FireBrick"}};break;case"rr":if(e>p.targetThreshold.rr)return{color:"Aqua",hoverStyle:{color:"Aqua"}};break;case"winrate":if(e>p.targetThreshold.winrate)return{color:"Fuchsia",hoverStyle:{color:"Fuchsia"}};break}}function P({value:e}){return r.shorten(e)}function y(e){let t=e.point.data.accProfit,i=m();if(i!==null){let a=c.value.data.find(C=>C.date===i).accProfit;t=t-a}return{html:`<div class='trade-chart-tooltip'>
>>>>>>>> parent of 180329f84 (ps add x2 y2):public/build/assets/Index-C-ibyeoR.js
