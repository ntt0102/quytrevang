import{_ as S}from"./chart-1fd9cc3c.js";import C from"./OpeningSummary-a33c1970.js";import z from"./Summary-1d5cef5b.js";import A from"./TrackStatisticPopup-78d2ffd6.js";import{u as F,a as B,r as D,c as L,z as V,b as d,e as o,d as g,f as R,g as E,F as q,h as M,j as N,k as b,l as j,o as u}from"./app-81f8f34e.js";import"./m_base_chart-53e45ce4.js";const G={class:"trades-page content-block dx-card responsive-paddings"},W={key:0},O=["fill"],U={key:1},Z=["fill"],ee={__name:"Index",setup(H){const f=M(),k=N(),{t:n}=F(),v=b("bus"),r=b("filters");let p={targetThreshold:{profit:0,rr:1,winrate:50}};const i=B({profit:!0,rr:!1,winrate:!1,accProfit:!0}),l=D(null),c=L(()=>f.state.tradingStatistic.charts);f.dispatch("tradingStatistic/getProfitChart",k.query.period??"day"),v.on("toggleMenu",()=>{setTimeout(()=>l.value.instance.render(),300)}),V(()=>v.off("toggleMenu"));function w(e){f.dispatch("tradingStatistic/getProfitChart",e)}function $({value:e,series:t}){switch(t.tag){case"profit":if(e<=p.targetThreshold.profit)return{color:"FireBrick",hoverStyle:{color:"FireBrick"}};break;case"rr":if(e>p.targetThreshold.rr)return{color:"Aqua",hoverStyle:{color:"Aqua"}};break;case"winrate":if(e>p.targetThreshold.winrate)return{color:"Fuchsia",hoverStyle:{color:"Fuchsia"}};break}}function P({value:e}){return r.shorten(e)}function y(e){let t=e.point.data.accProfit,s=m();if(s!==null){let a=c.value.data.find(_=>_.date===s).accProfit;t=t-a}return{html:`<div class='trade-chart-tooltip'>
