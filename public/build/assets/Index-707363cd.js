import{_ as S}from"./chart-0b425423.js";import C from"./OpeningSummary-fe93e81e.js";import A from"./Summary-1bbb9d4d.js";import z from"./TrackStatisticPopup-5f1dcf17.js";import{u as F,b as B,c as D,i as b,d as L,r as V,e as k,y as R,f as M,g as d,j as r,h as v,k as q,l as E,F as N,o as u}from"./app-0b384ab8.js";import"./m_base_chart-db97a25e.js";const j={class:"trades-page content-block dx-card responsive-paddings"},G={key:0},W=["fill"],O={key:1},U=["fill"],I={__name:"Index",setup(Z){const f=F(),w=B(),{t:o}=D(),g=b("bus"),n=b("filters");let p={targetThreshold:{profit:0,rr:1,winrate:50}};const i=L({profit:!0,rr:!1,winrate:!1,accProfit:!0}),l=V(null),c=k(()=>f.state.tradingStatistic.charts);k(()=>f.state.auth.user.permissions),f.dispatch("tradingStatistic/getProfitChart",w.query.period??"day"),g.on("toggleMenu",()=>{setTimeout(()=>l.value.instance.render(),300)}),R(()=>g.off("toggleMenu"));function $({value:e,series:t}){switch(t.tag){case"profit":if(e<=p.targetThreshold.profit)return{color:"FireBrick",hoverStyle:{color:"FireBrick"}};break;case"rr":if(e>p.targetThreshold.rr)return{color:"Aqua",hoverStyle:{color:"Aqua"}};break;case"winrate":if(e>p.targetThreshold.winrate)return{color:"Fuchsia",hoverStyle:{color:"Fuchsia"}};break}}function y({valueText:e}){return`${e.replace(",0","").replace("M"," Tr")}`}function P(e){let t=e.point.data.accProfit,s=m();if(s!==null){let a=c.value.data.find(_=>_.date===s).accProfit;t=t-a}return{html:`<div class='trade-chart-tooltip'>
                ...
                <div class='tooltip-body'>
                  <div class='series-name'>
                    <span class='bottom-series-name'>
                      ${o("trading.statistic.profitSum")}
                    </span>:
                  </div>
                  <div class='value-text'>
                    <span class='bottom-series-value' style='font-weight: bold; color:${e.point.data.profit>=0?"green":"red"}'>
                      ${n.shorten(e.point.data.profit,"₫")}
                    </span>
                  </div>
                  <div class='series-name'>
                    <span class='bottom-series-name'>
                      ${o("trading.statistic.rr")}
                    </span>:
                  </div>
                  <div class='value-text'>
                    <span class='bottom-series-value'>
                      ${n.numberVnFormat(e.point.data.rr,e.point.data.rr>2?0:1)}
                    </span>
                  </div>
                  <div class='series-name'>
                    <span class='bottom-series-name'>
                      ${o("trading.statistic.winrate")}
                    </span>:
                  </div>
                  <div class='value-text'>
                    <span class='bottom-series-value'>
                      ${n.numberVnFormat(e.point.data.winrate,0)}%
                    </span>
                  </div>
                  <div class='series-name'>
                    <span class='bottom-series-name'>
                      ${o("trading.statistic.accProfit")}
                    </span>:
                  </div>
                  <div class='value-text'>
                    <span class='bottom-series-value'>
