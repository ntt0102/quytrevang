import{D as S}from"./chart-2dc54a3f.js";import _ from"./OpeningSummary-6aed8b0a.js";import A from"./Summary-00b8f9ac.js";import z from"./TrackStatisticPopup-0556a12a.js";import{u as F,a as D,r as B,c as L,C as V,b as d,e as o,d as h,f as R,g as E,F as q,h as M,j as N,k as b,m as j,o as u}from"./app-a379b0c5.js";import"./m_base_chart-dc081653.js";import"./color-6daa04dd.js";import"./file_saver-4c47e254.js";const G={class:"trades-page content-block dx-card responsive-paddings"},W={key:0},O=["fill"],U={key:1},Z=["fill"],ae={__name:"Index",setup(H){const f=M(),k=N(),{t:n}=F(),g=b("bus"),r=b("filters");let p={targetThreshold:{profit:0,rr:1,winrate:50}};const s=D({profit:!0,rr:!1,winrate:!1,accProfit:!0}),l=B(null),c=L(()=>f.state.tradingShrstat.charts);f.dispatch("tradingShrstat/getProfitChart",k.query.period??"day"),g.on("toggleMenu",()=>{setTimeout(()=>l.value.instance.render(),300)}),V(()=>g.off("toggleMenu"));function w(e){f.dispatch("tradingShrstat/getProfitChart",e)}function $({value:e,series:t}){switch(t.tag){case"profit":if(e<=p.targetThreshold.profit)return{color:"FireBrick",hoverStyle:{color:"FireBrick"}};break;case"rr":if(e>p.targetThreshold.rr)return{color:"Aqua",hoverStyle:{color:"Aqua"}};break;case"winrate":if(e>p.targetThreshold.winrate)return{color:"Fuchsia",hoverStyle:{color:"Fuchsia"}};break}}function P({value:e}){return r.shorten(e)}function y(e){let t=e.point.data.accProfit,i=m();if(i!==null){let a=c.value.data.find(T=>T.date===i).accProfit;t=t-a}return{html:`<div class='trade-chart-tooltip'>
