import{_}from"./chart-6ad2bd3f.js";import C from"./TrackStatisticPopup-b7e251c4.js";import{u as A,b as z,c as L,i as b,d as B,r as D,e as y,z as V,f as R,g as n,j as v,k as q,l as M,o as d,h as c}from"./app-f65bb55a.js";import"./annotations-338a939b.js";const E={class:"trades-page content-block dx-card responsive-paddings"},N={key:0},O=["fill"],G={key:1},j=c("rect",{x:0,y:0,width:10,height:10,fill:"DarkGreen"},null,-1),W=c("rect",{x:10,y:0,width:7,height:10,fill:"FireBrick"},null,-1),U=c("rect",{x:17,y:0,width:3,height:10,fill:"DarkOrange"},null,-1),Z=[j,W,U],H={key:2},J=["fill"],ee={__name:"Index",setup(K){const m=A(),P=z(),{t:a}=L(),g=b("bus"),i=b("filters");let u={principalTargetThreshold:{day:1,week:5,month:22,quarter:65,year:260},feesTargetThreshold:5};const s=B({money:!0,profitPerPrincipal:!1,profitPerFees:!1,accumulatedProfit:!0}),p=D(null),o=y(()=>m.state.tradingStatistic.charts),k=y(()=>m.state.auth.user.permissions);m.dispatch("tradingStatistic/getChart",P.query.period??"day"),g.on("toggleMenu",()=>{setTimeout(()=>p.value.instance.render(),300)}),V(()=>g.off("toggleMenu"));function $({value:e,series:t}){return t.tag==="profitPerPrincipal"&&e>=u.principalTargetThreshold[o.value.period]?{color:"Aqua",hoverStyle:{color:"Aqua"}}:t.tag==="profitPerFees"&&e>=u.feesTargetThreshold?{color:"Fuchsia",hoverStyle:{color:"Fuchsia"}}:{color:t.color,hoverStyle:{color:t.color}}}function T({valueText:e}){return`${e.replace(",0","").replace("M"," Tr")}`}function x(e){let t=e.point.data.accumulatedProfit,l=f();if(l!==null){let r=o.value.data.find(S=>S.time===l).accumulatedProfit;t=t-r}return{html:`<div class='trade-chart-tooltip'>
