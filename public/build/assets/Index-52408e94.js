<<<<<<<< HEAD:public/build/assets/Index-153913fd.js
import{_ as S}from"./chart-33da3eaf.js";import C from"./OpeningSummary-7a5178dd.js";import A from"./Summary-774207e6.js";import z from"./TrackStatisticPopup-237774e3.js";import{u as F,a as B,r as D,c as L,E as V,b as d,e as o,d as h,f as R,g as E,F as q,h as M,j as N,k as b,m as j,o as u}from"./app-7823a389.js";import"./m_base_chart-3ce3d325.js";const G={class:"trades-page content-block dx-card responsive-paddings"},W={key:0},O=["fill"],U={key:1},Z=["fill"],ee={__name:"Index",setup(H){const f=M(),k=N(),{t:n}=F(),g=b("bus"),r=b("filters");let p={targetThreshold:{profit:0,rr:1,winrate:50}};const s=B({profit:!0,rr:!1,winrate:!1,accProfit:!0}),l=D(null),c=L(()=>f.state.tradingShrstat.charts);f.dispatch("tradingShrstat/getProfitChart",k.query.period??"day"),g.on("toggleMenu",()=>{setTimeout(()=>l.value.instance.render(),300)}),V(()=>g.off("toggleMenu"));function w(e){f.dispatch("tradingShrstat/getProfitChart",e)}function $({value:e,series:t}){switch(t.tag){case"profit":if(e<=p.targetThreshold.profit)return{color:"FireBrick",hoverStyle:{color:"FireBrick"}};break;case"rr":if(e>p.targetThreshold.rr)return{color:"Aqua",hoverStyle:{color:"Aqua"}};break;case"winrate":if(e>p.targetThreshold.winrate)return{color:"Fuchsia",hoverStyle:{color:"Fuchsia"}};break}}function P({value:e}){return r.shorten(e)}function y(e){let t=e.point.data.accProfit,i=m();if(i!==null){let a=c.value.data.find(_=>_.date===i).accProfit;t=t-a}return{html:`<div class='trade-chart-tooltip'>
========
import{_ as S}from"./chart-c47b5a81.js";import C from"./OpeningSummary-9e3f4cc5.js";import A from"./Summary-a56c27f1.js";import z from"./TrackStatisticPopup-152ecc1a.js";import{u as F,a as B,r as D,c as L,E as V,b as d,e as o,d as h,f as R,g as E,F as q,h as M,j as N,k as b,m as j,o as u}from"./app-f4c6c71e.js";import"./m_base_chart-49b753ad.js";/* empty css            */const G={class:"trades-page content-block dx-card responsive-paddings"},W={key:0},O=["fill"],U={key:1},Z=["fill"],te={__name:"Index",setup(H){const f=M(),k=N(),{t:n}=F(),g=b("bus"),r=b("filters");let p={targetThreshold:{profit:0,rr:1,winrate:50}};const s=B({profit:!0,rr:!1,winrate:!1,accProfit:!0}),l=D(null),c=L(()=>f.state.tradingShrstat.charts);f.dispatch("tradingShrstat/getProfitChart",k.query.period??"day"),g.on("toggleMenu",()=>{setTimeout(()=>l.value.instance.render(),300)}),V(()=>g.off("toggleMenu"));function w(e){f.dispatch("tradingShrstat/getProfitChart",e)}function $({value:e,series:t}){switch(t.tag){case"profit":if(e<=p.targetThreshold.profit)return{color:"FireBrick",hoverStyle:{color:"FireBrick"}};break;case"rr":if(e>p.targetThreshold.rr)return{color:"Aqua",hoverStyle:{color:"Aqua"}};break;case"winrate":if(e>p.targetThreshold.winrate)return{color:"Fuchsia",hoverStyle:{color:"Fuchsia"}};break}}function P({value:e}){return r.shorten(e)}function y(e){let t=e.point.data.accProfit,i=m();if(i!==null){let a=c.value.data.find(_=>_.date===i).accProfit;t=t-a}return{html:`<div class='trade-chart-tooltip'>
>>>>>>>> 4905e4cac7cccbdd1592842383b70a4894ec7d34:public/build/assets/Index-52408e94.js
