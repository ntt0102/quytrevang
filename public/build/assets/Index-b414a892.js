import{_ as w}from"./chart-69321598.js";import S from"./OpeningSummary-f1b81587.js";import C from"./Summary-e8a245fc.js";import A from"./TrackStatisticPopup-48724c66.js";import{u as z,b as L,c as B,i as b,d as D,r as V,e as y,y as R,f as q,g as c,j as d,h as n,k as M,l as E,F as N,o as u}from"./app-9b898d56.js";import"./m_base_chart-bc4f2835.js";const O={class:"trades-page content-block dx-card responsive-paddings"},G={key:0},j=["fill"],W={key:1},U=n("rect",{x:0,y:0,width:20,height:2,fill:"DarkOrange"},null,-1),Z=n("rect",{x:0,y:2,width:20,height:4,fill:"FireBrick"},null,-1),H=n("rect",{x:0,y:5,width:20,height:4,fill:"DarkGreen"},null,-1),J=[U,Z,H],K={key:2},Q=["fill"],ie={__name:"Index",setup(X){const f=z(),P=L(),{t:a}=B(),g=b("bus"),i=b("filters");let p={principalTargetThreshold:{day:1,week:5,month:22,quarter:65,year:260},feesTargetThreshold:5};const s=D({money:!0,profitPerPrincipal:!1,profitPerFees:!1,accumulatedProfit:!0}),m=V(null),l=y(()=>f.state.tradingStatistic.charts);y(()=>f.state.auth.user.permissions),f.dispatch("tradingStatistic/getChart",P.query.period??"day"),g.on("toggleMenu",()=>{setTimeout(()=>m.value.instance.render(),300)}),R(()=>g.off("toggleMenu"));function k({value:e,series:t}){return t.tag==="profitPerPrincipal"&&e>=p.principalTargetThreshold[l.value.period]?{color:"Aqua",hoverStyle:{color:"Aqua"}}:t.tag==="profitPerFees"&&e>=p.feesTargetThreshold?{color:"Fuchsia",hoverStyle:{color:"Fuchsia"}}:{color:t.color,hoverStyle:{color:t.color}}}function $({valueText:e}){return`${e.replace(",0","").replace("M"," Tr")}`}function T(e){let t=e.point.data.accumulatedProfit,o=v();if(o!==null){let r=l.value.data.find(_=>_.time===o).accumulatedProfit;t=t-r}return{html:`<div class='trade-chart-tooltip'>
                ...
                <div class='tooltip-body'>
                  ...
                  <div class='value-text'>
                    <span class='top-series-value'>
                      ...
                      (${(100*e.point.data.profitPerPrincipal/p.principalTargetThreshold[l.value.period]).toFixed(0)}%
