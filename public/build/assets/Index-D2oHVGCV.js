<<<<<<<< HEAD:public/build/assets/Index-CO6FYvbZ.js
import{D as S}from"./chart-DJiAFTxX.js";import A from"./OpeningSummary--n3kwlpd.js";import z from"./Summary-CTrJh6IX.js";import F from"./TrackStatisticPopup-Byj9Lj5c.js";import{u as D,a as _,r as B,c as L,H as V,b as d,e as o,d as h,f as R,g as E,F as q,h as M,j as N,k as b,m as j,o as u}from"./app-FUIMPKFr.js";import"./m_base_chart-B_CxmnrQ.js";const G={class:"trades-page content-block dx-card responsive-paddings"},W={key:0},H=["fill"],O={key:1},U=["fill"],ee={__name:"Index",setup(Z){const f=M(),k=N(),{t:n}=D(),g=b("bus"),r=b("filters");let p={targetThreshold:{profit:0,rr:1,winrate:50}};const s=_({profit:!0,rr:!1,winrate:!1,accProfit:!0}),l=B(null),c=L(()=>f.state.tradingShrstat.charts);f.dispatch("tradingShrstat/getProfitChart",k.query.period??"day"),g.on("toggleMenu",()=>{setTimeout(()=>l.value.instance.render(),300)}),V(()=>g.off("toggleMenu"));function w(e){f.dispatch("tradingShrstat/getProfitChart",e)}function $({value:e,series:t}){switch(t.tag){case"profit":if(e<=p.targetThreshold.profit)return{color:"FireBrick",hoverStyle:{color:"FireBrick"}};break;case"rr":if(e>p.targetThreshold.rr)return{color:"Aqua",hoverStyle:{color:"Aqua"}};break;case"winrate":if(e>p.targetThreshold.winrate)return{color:"Fuchsia",hoverStyle:{color:"Fuchsia"}};break}}function P({value:e}){return r.shorten(e)}function y(e){let t=e.point.data.accProfit,i=m();if(i!==null){let a=c.value.data.find(C=>C.date===i).accProfit;t=t-a}return{html:`<div class='trade-chart-tooltip'>
========
import{D as S}from"./chart-BcDYQT1Z.js";import A from"./OpeningSummary-B5OxRyym.js";import z from"./Summary-C4Gml7FH.js";import F from"./TrackStatisticPopup-90MTNsOJ.js";import{u as D,a as _,r as B,c as L,H as V,b as d,e as o,d as h,f as R,g as E,F as q,h as M,j as N,k as b,m as j,o as u}from"./app-DuGS5nbC.js";import"./m_base_chart-DLE6HUyp.js";/* empty css            */const G={class:"trades-page content-block dx-card responsive-paddings"},W={key:0},H=["fill"],O={key:1},U=["fill"],te={__name:"Index",setup(Z){const f=M(),k=N(),{t:n}=D(),g=b("bus"),r=b("filters");let p={targetThreshold:{profit:0,rr:1,winrate:50}};const s=_({profit:!0,rr:!1,winrate:!1,accProfit:!0}),l=B(null),c=L(()=>f.state.tradingShrstat.charts);f.dispatch("tradingShrstat/getProfitChart",k.query.period??"day"),g.on("toggleMenu",()=>{setTimeout(()=>l.value.instance.render(),300)}),V(()=>g.off("toggleMenu"));function w(e){f.dispatch("tradingShrstat/getProfitChart",e)}function $({value:e,series:t}){switch(t.tag){case"profit":if(e<=p.targetThreshold.profit)return{color:"FireBrick",hoverStyle:{color:"FireBrick"}};break;case"rr":if(e>p.targetThreshold.rr)return{color:"Aqua",hoverStyle:{color:"Aqua"}};break;case"winrate":if(e>p.targetThreshold.winrate)return{color:"Fuchsia",hoverStyle:{color:"Fuchsia"}};break}}function P({value:e}){return r.shorten(e)}function y(e){let t=e.point.data.accProfit,i=m();if(i!==null){let a=c.value.data.find(C=>C.date===i).accProfit;t=t-a}return{html:`<div class='trade-chart-tooltip'>
>>>>>>>> 881604fe6818b366e88c3c2071ecc4ceed2aefd4:public/build/assets/Index-D2oHVGCV.js
