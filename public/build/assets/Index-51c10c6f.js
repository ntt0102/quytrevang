import{_ as S}from"./chart-4015bc8d.js";import _ from"./TrackStatisticPopup-15be00d9.js";import{x as C,z as A,y as z,E as L,H as B,c as n,e as v,B as m,w as D,C as V,N as R,D as y,r as q,o as c,d}from"./app-7d2890ad.js";import"./annotations-0a6c9aac.js";import"./exporter-840113be.js";import"./data-grid-fa375ee2.js";import"./row_dragging-58358548.js";import"./dialog-81c627ab.js";const E={class:"trades-page content-block dx-card responsive-paddings"},M={key:0},N=["fill"],O={key:1},G=d("rect",{x:0,y:0,width:10,height:10,fill:"DarkGreen"},null,-1),W=d("rect",{x:10,y:0,width:7,height:10,fill:"FireBrick"},null,-1),j=d("rect",{x:17,y:0,width:3,height:10,fill:"DarkOrange"},null,-1),H=[G,W,j],U={key:2},Z=["fill"],se={__name:"Index",setup(J){const g=V(),P=R(),{t:a}=C(),h=y("bus"),i=y("filters");let u={principalTargetThreshold:{day:1,week:5,month:22,quarter:65,year:260},feesTargetThreshold:5};const s=A({money:!0,profitPerPrincipal:!1,profitPerFees:!1,accumulatedProfit:!0}),p=z(null),o=L(()=>g.state.tradingStatistic.charts);g.dispatch("tradingStatistic/getChart",P.query.period??"day"),h.on("toggleMenu",()=>{setTimeout(()=>p.value.instance.render(),300)}),B(()=>h.off("toggleMenu"));function k({value:e,series:t}){return t.tag==="profitPerPrincipal"&&e>=u.principalTargetThreshold[o.value.period]?{color:"Aqua",hoverStyle:{color:"Aqua"}}:t.tag==="profitPerFees"&&e>=u.feesTargetThreshold?{color:"Fuchsia",hoverStyle:{color:"Fuchsia"}}:{color:t.color,hoverStyle:{color:t.color}}}function $({valueText:e}){return`${e.replace(",0","").replace("M"," Tr")}`}function T(e){let t=e.point.data.accumulatedProfit,l=f();if(l!==null){let r=o.value.data.find(w=>w.time===l).accumulatedProfit;t=t-r}return{html:`<div class='trade-chart-tooltip'>
