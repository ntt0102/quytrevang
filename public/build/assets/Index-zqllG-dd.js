import{D as S}from"./chart-SHFCvnAu.js";import C from"./TrackStatisticPopup-VTmcowWt.js";import{u as A,b as z,c as _,i as b,d as L,r as B,e as y,y as D,f as V,o as n,g as c,j as v,k as R,l as q,h as d}from"./app-yhzx4Rdz.js";import"./m_base_chart-Aksdlhrw.js";import"./color-O4QqY7rP.js";import"./file_saver-UqqVy57Q.js";const M={class:"trades-page content-block dx-card responsive-paddings"},E={key:0},N=["fill"],O={key:1},G=d("rect",{x:0,y:0,width:20,height:2,fill:"DarkOrange"},null,-1),j=d("rect",{x:0,y:2,width:20,height:4,fill:"FireBrick"},null,-1),W=d("rect",{x:0,y:5,width:20,height:4,fill:"DarkGreen"},null,-1),U=[G,j,W],Z={key:2},H=["fill"],te={__name:"Index",setup(J){const m=A(),P=z(),{t:a}=_(),g=b("bus"),i=b("filters");let u={principalTargetThreshold:{day:1,week:5,month:22,quarter:65,year:260},feesTargetThreshold:5};const s=L({money:!0,profitPerPrincipal:!1,profitPerFees:!1,accumulatedProfit:!0}),p=B(null),o=y(()=>m.state.tradingStatistic.charts);y(()=>m.state.auth.user.permissions),m.dispatch("tradingStatistic/getChart",P.query.period??"day"),g.on("toggleMenu",()=>{setTimeout(()=>p.value.instance.render(),300)}),D(()=>g.off("toggleMenu"));function k({value:e,series:t}){return t.tag==="profitPerPrincipal"&&e>=u.principalTargetThreshold[o.value.period]?{color:"Aqua",hoverStyle:{color:"Aqua"}}:t.tag==="profitPerFees"&&e>=u.feesTargetThreshold?{color:"Fuchsia",hoverStyle:{color:"Fuchsia"}}:{color:t.color,hoverStyle:{color:t.color}}}function $({valueText:e}){return`${e.replace(",0","").replace("M"," Tr")}`}function T(e){let t=e.point.data.accumulatedProfit,l=f();if(l!==null){let r=o.value.data.find(w=>w.time===l).accumulatedProfit;t=t-r}return{html:`<div class='trade-chart-tooltip'>
