  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapActions"])("Admin.orderChart", ["getChartData", "getStatus", "getConfig", "executeOrder"])), {}, {
    ...
    eventFullscreenChange: function eventFullscreenChange() {
      if (document.fullscreenElement) {
        ...
        document.querySelector(".side-navigation-menu").style.transform = "transform: translate(-250px, 0px)";
      } else {
        this.isFullscreen = false;
        this.chartContainer.classList.remove("fullscreen"); // document.querySelector(".dx-drawer-content").style.transform =
        //     "translate(0px, 0px)";

        document.querySelector(".side-navigation-menu").style.transform = "unset";
      }
    },
