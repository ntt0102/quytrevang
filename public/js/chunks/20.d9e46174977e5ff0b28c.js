...
/* harmony import */ var _core_guid__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../core/guid */ "./node_modules/devextreme/esm/core/guid.js");
/**
...
class FileItemsController {
    ...
    downloadItems(itemInfos) {
        ...
        return Object(_core_utils_deferred__WEBPACK_IMPORTED_MODULE_9__["when"])(...deferreds).then(() => {
            var items = itemInfos.map(i => i.fileItem);
            return Object(_core_utils_deferred__WEBPACK_IMPORTED_MODULE_9__["when"])(this._getItemActionResult(this._fileProvider.downloadItems(items))).then(() => {}, errorInfo => {
    ...
    _processEditAction(actionInfo, beforeAction, action, afterAction, completeAction) {
        ...
        this._raiseEditActionResultAcquired(actionInfo);
        return Object(_ui_file_manager_common__WEBPACK_IMPORTED_MODULE_8__["whenSome"])(actionResult, info => {
    ...
    startSingleLoad() {
        this._singleOperationLockId = (new _core_guid__WEBPACK_IMPORTED_MODULE_14__["default"]).toString()
    }
    endSingleLoad() {
...
class FileManagerFolderChooserDialog extends _ui_file_manager_dialog__WEBPACK_IMPORTED_MODULE_4__["default"] {
    ...
    switchToCopyDialog(targetItemInfos) {
        ...
        this._setApplyButtonOptions({
            text: _localization_message__WEBPACK_IMPORTED_MODULE_2__["default"].format("dxFileManager-dialogDirectoryChooserCopyButtonText"),
            disabled: true
        })
    }
    switchToMoveDialog(targetItemInfos) {
        ...
        this._setApplyButtonOptions({
            text: _localization_message__WEBPACK_IMPORTED_MODULE_2__["default"].format("dxFileManager-dialogDirectoryChooserMoveButtonText"),
            disabled: true
        })
    }
    _getDialogOptions() {
...
/* harmony import */ var _ui_file_manager_dialog_manager__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./ui.file_manager.dialog_manager */ "./node_modules/devextreme/esm/ui/file_manager/ui.file_manager.dialog_manager.js");
/* harmony import */ var _ui_file_manager_file_uploader__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./ui.file_manager.file_uploader */ "./node_modules/devextreme/esm/ui/file_manager/ui.file_manager.file_uploader.js");
/* harmony import */ var _ui_file_manager_messages__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./ui.file_manager.messages */ "./node_modules/devextreme/esm/ui/file_manager/ui.file_manager.messages.js");
/**
...
class FileManagerEditingControl extends _widget_ui_widget__WEBPACK_IMPORTED_MODULE_7__["default"] {
    _initMarkup() {
        super._initMarkup();
        this._initActions();
        ...
        this._dialogManager = new _ui_file_manager_dialog_manager__WEBPACK_IMPORTED_MODULE_8__["default"](this.$element(), {
    ...
    _getFileUploaderComponent() {
        return _ui_file_manager_file_uploader__WEBPACK_IMPORTED_MODULE_9__["default"]
    }
    _createFileUploader() {
    ...
    _createMetadataMap() {
        this._metadataMap = {
            create: {
                ...
                singleItemProcessingMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingCreateSingleItemProcessingMessage"),
                singleItemSuccessMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingCreateSingleItemSuccessMessage"),
                singleItemErrorMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingCreateSingleItemErrorMessage"),
                commonErrorMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingCreateCommonErrorMessage")
            },
            rename: {
                action: arg => this._tryRename(arg),
                singleItemProcessingMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingRenameSingleItemProcessingMessage"),
                singleItemSuccessMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingRenameSingleItemSuccessMessage"),
                singleItemErrorMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingRenameSingleItemErrorMessage"),
                commonErrorMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingRenameCommonErrorMessage")
            },
            delete: {
                action: arg => this._tryDelete(arg),
                singleItemProcessingMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingDeleteSingleItemProcessingMessage"),
                multipleItemsProcessingMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingDeleteMultipleItemsProcessingMessage"),
                singleItemSuccessMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingDeleteSingleItemSuccessMessage"),
                multipleItemsSuccessMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingDeleteMultipleItemsSuccessMessage"),
                singleItemErrorMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingDeleteSingleItemErrorMessage"),
                multipleItemsErrorMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingDeleteMultipleItemsErrorMessage"),
                commonErrorMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingDeleteCommonErrorMessage")
            },
            move: {
                action: arg => this._tryMove(arg),
                singleItemProcessingMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingMoveSingleItemProcessingMessage"),
                multipleItemsProcessingMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingMoveMultipleItemsProcessingMessage"),
                singleItemSuccessMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingMoveSingleItemSuccessMessage"),
                multipleItemsSuccessMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingMoveMultipleItemsSuccessMessage"),
                singleItemErrorMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingMoveSingleItemErrorMessage"),
                multipleItemsErrorMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingMoveMultipleItemsErrorMessage"),
                commonErrorMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingMoveCommonErrorMessage")
            },
            copy: {
                action: arg => this._tryCopy(arg),
                singleItemProcessingMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingCopySingleItemProcessingMessage"),
                multipleItemsProcessingMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingCopyMultipleItemsProcessingMessage"),
                singleItemSuccessMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingCopySingleItemSuccessMessage"),
                multipleItemsSuccessMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingCopyMultipleItemsSuccessMessage"),
                singleItemErrorMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingCopySingleItemErrorMessage"),
                multipleItemsErrorMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingCopyMultipleItemsErrorMessage"),
                commonErrorMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingCopyCommonErrorMessage")
            },
            upload: {
                action: arg => this._tryUpload(arg),
                allowCancel: true,
                allowItemProgress: true,
                singleItemProcessingMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingUploadSingleItemProcessingMessage"),
                multipleItemsProcessingMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingUploadMultipleItemsProcessingMessage"),
                singleItemSuccessMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingUploadSingleItemSuccessMessage"),
                multipleItemsSuccessMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingUploadMultipleItemsSuccessMessage"),
                singleItemErrorMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingUploadSingleItemErrorMessage"),
                multipleItemsErrorMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingUploadMultipleItemsErrorMessage"),
                canceledMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingUploadCanceledMessage")
            },
            download: {
                action: arg => this._download(arg),
                singleItemProcessingMessage: "",
                multipleItemsProcessingMessage: "",
                singleItemErrorMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingDownloadSingleItemErrorMessage"),
                multipleItemsErrorMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-editingDownloadMultipleItemsErrorMessage")
            },
            getItemContent: {
            ...
            getItems: {
                singleItemProcessingMessage: "",
                singleItemErrorMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-errorDirectoryOpenFailed"),
                commonErrorMessage: _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-errorDirectoryOpenFailed")
            }
        }
    }
    getCommandActions() {
    ...
    _scheduleUploadSessionDisposal(sessionId, requester) {
        if (Object(_core_utils_type__WEBPACK_IMPORTED_MODULE_5__["isDefined"])(this._uploadOperationInfoMap[sessionId].requester) && this._uploadOperationInfoMap[sessionId].requester !== requester) {
    ...
    _tryCreate(parentDirectories) {
        ...
        var newDirName = _localization_message__WEBPACK_IMPORTED_MODULE_6__["default"].format("dxFileManager-newDirectoryName");
    ...
    _getErrorText(errorInfo, itemInfo, itemName) {
        var errorText = errorInfo.errorText || _ui_file_manager_messages__WEBPACK_IMPORTED_MODULE_10__["FileManagerMessages"].get(errorInfo.errorCode, itemName);
        var errorArgs = {
...
class FileManagerActionContext {
    ...
    _isItemExistsErrorCode(errorCode) {
        return errorCode === _ui_file_manager_messages__WEBPACK_IMPORTED_MODULE_10__["ErrorCode"].DirectoryExists || errorCode === _ui_file_manager_messages__WEBPACK_IMPORTED_MODULE_10__["ErrorCode"].FileExists
    }
...
class FileUploader extends _editor_editor__WEBPACK_IMPORTED_MODULE_13__["default"] {
    ...
    _updateTotalProgress(totalFilesSize, totalLoadedFilesSize) {
        var progress = 0;
        if (Object(_core_utils_type__WEBPACK_IMPORTED_MODULE_7__["isDefined"])(totalFilesSize)) {
...
/* harmony import */ var _core_guid__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../core/guid */ "./node_modules/devextreme/esm/core/guid.js");
/**
...
class SplitterControl extends _widget_ui_widget__WEBPACK_IMPORTED_MODULE_1__["default"] {
    _init() {
        super._init();
        var eventGuid = (new _core_guid__WEBPACK_IMPORTED_MODULE_7__["default"]).toString();
        this.SPLITTER_POINTER_DOWN_EVENT_NAME = Object(_events_utils_index__WEBPACK_IMPORTED_MODULE_6__["addNamespace"])(_events_pointer__WEBPACK_IMPORTED_MODULE_4__["default"].down, SPLITTER_MODULE_NAMESPACE + eventGuid);
        this.SPLITTER_POINTER_MOVE_EVENT_NAME = Object(_events_utils_index__WEBPACK_IMPORTED_MODULE_6__["addNamespace"])(_events_pointer__WEBPACK_IMPORTED_MODULE_4__["default"].move, SPLITTER_MODULE_NAMESPACE + eventGuid);
        this.SPLITTER_POINTER_UP_EVENT_NAME = Object(_events_utils_index__WEBPACK_IMPORTED_MODULE_6__["addNamespace"])(_events_pointer__WEBPACK_IMPORTED_MODULE_4__["default"].up, SPLITTER_MODULE_NAMESPACE + eventGuid)
    }
    _initMarkup() {
        super._initMarkup();
        this._initActions();
    ...
    _attachEventHandlers() {
        ...
        _events_core_events_engine__WEBPACK_IMPORTED_MODULE_3__["default"].on(this._$splitterBorder, this.SPLITTER_POINTER_DOWN_EVENT_NAME, this._onMouseDownHandler.bind(this));
        _events_core_events_engine__WEBPACK_IMPORTED_MODULE_3__["default"].on(document, this.SPLITTER_POINTER_MOVE_EVENT_NAME, this._onMouseMoveHandler.bind(this));
        _events_core_events_engine__WEBPACK_IMPORTED_MODULE_3__["default"].on(document, this.SPLITTER_POINTER_UP_EVENT_NAME, this._onMouseUpHandler.bind(this))
    }
    _detachEventHandlers() {
        var document = _core_dom_adapter__WEBPACK_IMPORTED_MODULE_2__["default"].getDocument();
        _events_core_events_engine__WEBPACK_IMPORTED_MODULE_3__["default"].off(this._$splitterBorder, this.SPLITTER_POINTER_DOWN_EVENT_NAME);
        _events_core_events_engine__WEBPACK_IMPORTED_MODULE_3__["default"].off(document, this.SPLITTER_POINTER_MOVE_EVENT_NAME);
        _events_core_events_engine__WEBPACK_IMPORTED_MODULE_3__["default"].off(document, this.SPLITTER_POINTER_UP_EVENT_NAME)
    }
    _dimensionChanged(dimension) {
        if (!dimension || "height" !== dimension) {
