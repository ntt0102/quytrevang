...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      validationRules: [{
        type: "required",
        message: this.$t("settings.command.title") + this.$mt.validations.required
      }]
    };
  },
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])("Settings", ["runCommand"])), {}, {
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }, [_vm._v("\n        " + _vm._s(_vm.$t("settings.command.title")) + "\n    ")]), _vm._v(" "), _c("div", {
    ...
    attrs: {
      ...
      "button-options": {
        ...
        type: "default",
        icon: "far fa-running",
        text: _vm.$t("settings.command.run"),
