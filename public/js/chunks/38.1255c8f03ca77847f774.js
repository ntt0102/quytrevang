...
/* harmony import */ var _store_modules_Settings_Parameters__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../store/modules/Settings/Parameters */ "./resources/js/store/modules/Settings/Parameters.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      validationRules: {
        value: [{
          type: "required",
          message: this.$t("settings.parameters.value") + this.$mt.validations.required
        }]
      }
    };
  },
  beforeCreate: function beforeCreate() {
    this.$store.registerModule("Settings.parameters", _store_modules_Settings_Parameters__WEBPACK_IMPORTED_MODULE_2__["default"]);
  },
  ...
  computed: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapGetters"])("Settings.parameters", ["parameters"])), {}, {
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])("Settings.parameters", ["fetch", "save", "resetState"])), {}, {
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }, [_vm._v("\n        " + _vm._s(_vm.$t("settings.parameters.title")) + "\n    ")]), _vm._v(" "), _c("div", {
    ...
    attrs: {
      ...
      caption: _vm.$t("settings.parameters.description")
    }
  }), _vm._v(" "), _c("DxColumn", {
    attrs: {
      "data-field": "value",
      caption: _vm.$t("settings.parameters.value"),
