...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      validationRules: {
        topic: [{
          type: "required",
          message: this.$t("settings.faqs.topic") + this.$mt.validations.required
        }],
        question: [{
          type: "required",
          message: this.$t("settings.faqs.question") + this.$mt.validations.required
        }],
        answer: [{
          type: "required",
          message: this.$t("settings.faqs.answer") + this.$mt.validations.required
        }]
      }
    };
  },
  beforeCreate: function beforeCreate() {
    this.$store.registerModule("Settings.faqs", _store_modules_Settings_Faqs__WEBPACK_IMPORTED_MODULE_5__["default"]);
  },
  ...
  computed: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapGetters"])("Settings.faqs", ["faqs"])), {}, {
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])("Settings.faqs", ["fetch", "save", "resetState"])), {}, {
    ...
    onInitNewRow: function onInitNewRow(e) {
      this.dataGrid.option("editing.popup.title", this.$t("settings.faqs.popup.create"));
    },
    onEditingStart: function onEditingStart(e) {
      ...
      this.dataGrid.option("editing.popup.title", this.$t("settings.faqs.popup.edit"));
    },
...
var render = function render() {
  ...
  }, [_vm._v("\n        " + _vm._s(_vm.$t("settings.faqs.title")) + "\n    ")]), _vm._v(" "), _c("div", {
