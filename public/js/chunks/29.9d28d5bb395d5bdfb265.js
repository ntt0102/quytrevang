...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/Trading/OrderChart.vue?vue&type=script&lang=js&":
/*!************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/views/Trading/OrderChart.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************/
...
/* harmony import */ var _plugins_orderChartDb_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../plugins/orderChartDb.js */ "./resources/js/plugins/orderChartDb.js");
...
/* harmony import */ var devextreme_ui_dialog__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! devextreme/ui/dialog */ "./node_modules/devextreme/esm/ui/dialog.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  beforeCreate: function beforeCreate() {
    this.$store.registerModule("Trading.orderChart", _store_modules_Admin_OrderChart__WEBPACK_IMPORTED_MODULE_2__["default"]);
  ...
  created: function created() {
    ...
    _plugins_orderChartDb_js__WEBPACK_IMPORTED_MODULE_1__["default"].create();
  },
  ...
  computed: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapGetters"])("Trading.orderChart", ["chartData", "status", "config", "isChartLoading"])), {}, {
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])("Trading.orderChart", ["getChartData", "getStatus", "getConfig", "executeOrder"])), {}, {
          ...
          if (newPrice != oldPrice) {
            ...
            if (lineOptions.kind == "entry") {
              if (!this.order.position) {
                ...
                this.executeOrder({
                  ...
                  if (resp.isOk) {
                    ...
                    _this2.$toasted.success(_this2.$t("trading.orderChart.changeEntrySuccess"));
                  } else {
                    line.applyOptions({
                      price: oldPrice
                    });
              ...
              if (lineOptions.kind == "tp") this.executeOrder({
                ...
                if (resp.isOk) {
                  _this2.drawOrderLine(lineOptions.kind);
                  _this2.$toasted.success(_this2.$t("trading.orderChart.changeTpSuccess"));
                } else {
                  line.applyOptions({
                    price: oldPrice
                  });
                ...
                if (resp.isOk) {
                  _this2.drawOrderLine(lineOptions.kind);
                  _this2.$toasted.success(_this2.$t("trading.orderChart.changeSlSuccess"));
                } else {
                  line.applyOptions({
                    price: oldPrice
                  });
            ...
            if (!isChanged) {
              ...
              this.$toasted.show(this.$t("trading.orderChart.noChangeOrderLine"));
            }
          }
          break;
        case "line":
          _plugins_orderChartDb_js__WEBPACK_IMPORTED_MODULE_1__["default"].set("line", {
            price: oldPrice,
            removed: true
          });
          _plugins_orderChartDb_js__WEBPACK_IMPORTED_MODULE_1__["default"].set("line", lineOptions);
          this.$refs.lineTool.classList.remove("selected");
          break;
        case "ruler":
          if (lineOptions.point == 1) {
            _plugins_orderChartDb_js__WEBPACK_IMPORTED_MODULE_1__["default"].set("ruler", lineOptions);
            if (this.ruler.point == 2) {
              ...
              _plugins_orderChartDb_js__WEBPACK_IMPORTED_MODULE_1__["default"].set("ruler", this.ruler.end.options());
            }
          } else {
            ...
            _plugins_orderChartDb_js__WEBPACK_IMPORTED_MODULE_1__["default"].set("ruler", line.options());
          }
          break;
      }
    },
    eventChartResize: function eventChartResize() {
      ...
      if (this.chartContainer.classList.contains("fullscreen")) {
        ...
        document.querySelector(".dx-drawer-panel-content").style.transform = "translate(-250px, 0px)";
      }
    },
    ...
    eventFullscreenChange: function eventFullscreenChange() {
      if (document.fullscreenElement) {
        ...
        document.querySelector(".dx-drawer-panel-content").style.transform = "unset";
      }
    },
        ...
        var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve) {
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _plugins_orderChartDb_js__WEBPACK_IMPORTED_MODULE_1__["default"].get("order");
              case 2:
                order = _context.sent;
                ...
                //
                _context.next = 7;
                return _plugins_orderChartDb_js__WEBPACK_IMPORTED_MODULE_1__["default"].get("line");
              case 7:
                lines = _context.sent;
                ...
                //
                _context.next = 11;
                return _plugins_orderChartDb_js__WEBPACK_IMPORTED_MODULE_1__["default"].get("ruler");
              case 11:
                      ...
                      if (!self.isAutoOrdering) {
                        ...
                        self.executeOrder({
                          ...
                          if (resp.isOk) {
                            ...
                            self.$toasted.success(_this4.$t("trading.orderChart.deleteTpSuccess"));
                      ...
                      if (!self.isAutoOrdering) {
                        ...
                        self.executeOrder({
                          ...
                          if (resp.isOk) {
                            ...
                            self.toggleCancelOrderButton(false);
                            _plugins_orderChartDb_js__WEBPACK_IMPORTED_MODULE_1__["default"].clear("order");
                            self.$toasted.success(_this4.$t("trading.orderChart.deleteSlSuccess"));
                            _this4.hideOrderButton();
                          } else self.toasteOrderError(resp.message);
                          self.isAutoOrdering = false;
                        });
                      ...
                      if (!self.isAutoOrdering) {
                        ...
                        self.executeOrder({
                          ...
                          if (resp.isOk) {
                            ...
                            self.$toasted.success(_this4.$t("trading.orderChart.autoNewTpSlSuccess"));
                          } else self.toasteOrderError(resp.message);
                          self.isAutoOrdering = false;
                        });
                      }
            ...
            if (CURRENT_SEC > TIME.ATC - 60 && this.order.tp.hasOwnProperty("line")) {
              this.executeOrder({
                ...
                if (resp.isOk) {
                  ...
                  _this5.toggleCancelOrderButton(false);
                  _plugins_orderChartDb_js__WEBPACK_IMPORTED_MODULE_1__["default"].clear("order");
                  _this5.$toasted.success(_this5.$t("trading.orderChart.autoCancelTpSlSuccess"));
    ...
    drawOrderLine: function drawOrderLine(kind) {
      ...
      _plugins_orderChartDb_js__WEBPACK_IMPORTED_MODULE_1__["default"].set("order", {
        kind: kind,
        price: +this.order[kind].price,
        side: this.order.side
      });
    ...
    drawLineTool: function drawLineTool() {
      ...
      if (existIndex != -1) {
        ...
        _plugins_orderChartDb_js__WEBPACK_IMPORTED_MODULE_1__["default"].set("line", options);
      }
      this.$refs.lineTool.classList.remove("selected");
    },
    removeLineTool: function removeLineTool() {
      ...
      this.lines = [];
      _plugins_orderChartDb_js__WEBPACK_IMPORTED_MODULE_1__["default"].clear("line");
    },
    ...
    drawRulerTool: function drawRulerTool() {
      ...
      if (this.ruler.point == 0) {
        ...
        _plugins_orderChartDb_js__WEBPACK_IMPORTED_MODULE_1__["default"].set("ruler", options);
    ...
    removeRulerTool: function removeRulerTool() {
      if (this.ruler.point > 0) {
        ...
        _plugins_orderChartDb_js__WEBPACK_IMPORTED_MODULE_1__["default"].clear("ruler");
      }
    },
    cancelOrderClick: function cancelOrderClick() {
      var _this7 = this;
      var result = Object(devextreme_ui_dialog__WEBPACK_IMPORTED_MODULE_3__["confirm"])(this.$t("trading.orderChart.cancelOrder"), this.$t("trading.orderChart.cancelConfirm"));
            ...
            if (_this7.order.tp.hasOwnProperty("line")) {
              _this7.executeOrder({
                ...
                if (resp.isOk) {
                  ...
                  _plugins_orderChartDb_js__WEBPACK_IMPORTED_MODULE_1__["default"].clear("order");
                  _this7.$toasted.success(_this7.$t("trading.orderChart.exitSuccess"));
                } else {
              ...
              _this7.executeOrder({
                ...
                if (resp.isOk) {
                  ...
                  _this7.toggleCancelOrderButton(false);
                  _plugins_orderChartDb_js__WEBPACK_IMPORTED_MODULE_1__["default"].clear("order");
                  _this7.$toasted.success(_this7.$t("trading.orderChart.deleteEntrySuccess"));
                } else {
                  _this7.toggleCancelOrderButton(true);
                  _this7.toasteOrderError(resp.message);
                }
    ...
    entryOrderClick: function entryOrderClick() {
      ...
      if (this.inSession(CURRENT_SEC)) {
        if (CURRENT_SEC < TIME.ATO) {
          var result = Object(devextreme_ui_dialog__WEBPACK_IMPORTED_MODULE_3__["confirm"])(this.$t("trading.orderChart.atoOrder"), this.$t("trading.orderChart.cancelConfirm"));
          result.then(function (dialogResult) {
            if (dialogResult) {
              _this8.executeOrder({
                action: "exit",
                ...
                if (resp.isOk) _this8.$toasted.success(_this8.$t("trading.orderChart.atoOrderSuccess"));else _this8.toasteOrderError(resp.message);
              });
            }
          });
          ...
          this.executeOrder({
            ...
            if (resp.isOk) {
              ...
              _this8.$toasted.success(_this8.$t("trading.orderChart.newEntrySuccess"));
            } else _this8.toasteOrderError(resp.message);
          });
        } else {
          var _result = Object(devextreme_ui_dialog__WEBPACK_IMPORTED_MODULE_3__["confirm"])(this.$t("trading.orderChart.atcOrder"), this.$t("trading.orderChart.cancelConfirm"));
          _result.then(function (dialogResult) {
            if (dialogResult) {
              _this8.executeOrder({
                ...
                if (resp.isOk) _this8.$toasted.success(_this8.$t("trading.orderChart.atcOrderSuccess"));else _this8.toasteOrderError(resp.message);
              });
            }
          });
        }
    ...
    tpslOrderClick: function tpslOrderClick() {
      ...
      this.executeOrder({
        ...
        if (resp.isOk) {
          ...
          _this9.$toasted.success(_this9.$t("trading.orderChart.newTpSlSuccess"));
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/Trading/OrderChart.vue?vue&type=template&id=eb989946&scoped=true&":
/*!**********************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/views/Trading/OrderChart.vue?vue&type=template&id=eb989946&scoped=true& ***!
  \**********************************************************************************************************************************************************************************************************************************************************/
...
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c("div", {
    staticClass: "order-chart-page"
  }, [_c("h2", {
    staticClass: "content-block"
  }, [_vm._v("\n        " + _vm._s(_vm.$t("trading.orderChart.title")) + "\n    ")]), _vm._v(" "), _c("div", {
    staticClass: "content-block dx-card responsive-paddings"
  }, [_c("div", {
    ref: "chartContainer",
    staticClass: "order-chart-container"
  }, [_c("div", {
    ref: "orderChart",
    staticClass: "chart-wrapper"
  }, [_c("div", {
    staticClass: "area data-area"
  }, [_c("div", {
    "class": "command noaction far fa-".concat(_vm.status.connection ? "link" : "unlink"),
    attrs: {
      title: _vm.$t("trading.orderChart.connection")
    }
  }), _vm._v(" "), _c("div", {
    ...
    attrs: {
      title: _vm.$t("trading.orderChart.position")
    }
  }, [_vm._v("\n                        " + _vm._s(_vm._f("currency")(_vm.status.position, "", "")) + "\n                    ")]), _vm._v(" "), _c("div", {
    staticClass: "command noaction clock"
  }, [_vm._v(_vm._s(_vm.clock))]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.chartDate,
    ...
    attrs: {
      type: "date",
      title: _vm.$t("trading.orderChart.date")
    },
    domProps: {
      value: _vm.chartDate
    },
    ...
    staticClass: "area tool-area"
  }, [_c("div", {
    ref: "fullscreenTool",
    "class": "command far fa-".concat(_vm.isFullscreen ? "compress" : "expand"),
    attrs: {
      title: _vm.$t("trading.orderChart.fullscreen")
    },
    on: {
    ...
    attrs: {
      title: _vm.$t("trading.orderChart.reload")
    },
    on: {
    ...
    attrs: {
      title: _vm.$t("trading.orderChart.lineTool")
    },
    on: {
    ...
    attrs: {
      title: _vm.$t("trading.orderChart.rulerTool")
    },
    on: {
    ...
    attrs: {
      title: _vm.$t("trading.orderChart.cancelTool")
    },
    on: {
      click: _vm.cancelOrderClick
    }
  })]), _vm._v(" "), _c("div", [_c("div", {
    ref: "entryOrder",
    staticClass: "order-button entry",
    on: {
      click: _vm.entryOrderClick
    }
  }, [_vm._v("\n                        Entry\n                    ")]), _vm._v(" "), _c("div", {
    ref: "tpslOrder",
    staticClass: "order-button tpsl",
    on: {
      click: _vm.tpslOrderClick
    }
  }, [_vm._v("\n                        TP/SL\n                    ")]), _vm._v(" "), _c("div", {
    staticClass: "chart-top command far fa-angle-double-right",
    on: {
      click: _vm.chartTopClick
    }
  })])])])])]);
};
var staticRenderFns = [];
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/Trading/OrderChart.vue?vue&type=style&index=0&id=eb989946&lang=scss&scoped=true&":
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--7-2!./node_modules/sass-loader/dist/cjs.js??ref--7-3!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/views/Trading/OrderChart.vue?vue&type=style&index=0&id=eb989946&lang=scss&scoped=true& ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
// module
exports.push([module.i, ".order-chart-container[data-v-eb989946] {\n  height: 300px;\n  background: #131722;\n  border: none;\n}\n.order-chart-container.fullscreen[data-v-eb989946] {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100vw;\n  height: 100vh;\n  z-index: 1501;\n}\n.order-chart-container .chart-wrapper[data-v-eb989946] {\n  position: relative;\n  height: 100%;\n}\n.order-chart-container .area[data-v-eb989946] {\n  position: absolute;\n  display: flex;\n  justify-content: space-between;\n  font-size: 17px;\n  background: #131722;\n  border: solid 2px #2a2e39;\n  border-bottom-right-radius: 5px;\n  z-index: 3;\n}\n.order-chart-container .area.data-area[data-v-eb989946] {\n  top: 0px;\n  left: 0px;\n}\n.order-chart-container .area.data-area .command[data-v-eb989946]:not(:first-child) {\n  border-left: solid 2px #2a2e39 !important;\n}\n.order-chart-container .area.data-area .clock[data-v-eb989946] {\n  width: 80px;\n}\n.order-chart-container .area.data-area .chart-date[data-v-eb989946] {\n  width: 125px;\n}\n.order-chart-container .area.data-area .status[data-v-eb989946] {\n  width: unset !important;\n  padding: 0 10px !important;\n}\n.order-chart-container .area.data-area .status.green[data-v-eb989946] {\n  color: lime !important;\n}\n.order-chart-container .area.data-area .status.red[data-v-eb989946] {\n  color: red !important;\n}\n.order-chart-container .area.data-area .spinner[data-v-eb989946] {\n  width: 30px;\n  height: 30px;\n  display: none;\n}\n.order-chart-container .area.tool-area[data-v-eb989946] {\n  top: 32px;\n  left: 0px;\n  flex-direction: column;\n}\n.order-chart-container .area.tool-area .command[data-v-eb989946]:not(:first-child) {\n  border-top: solid 2px #2a2e39 !important;\n}\n.order-chart-container .area.tool-area .selected[data-v-eb989946] {\n  color: #1f62ff !important;\n}\n.order-chart-container .area.tool-area .warning[data-v-eb989946] {\n  color: yellow !important;\n}\n.order-chart-container .area.tool-area .cancel-order[data-v-eb989946] {\n  display: none;\n  color: red;\n}\n.order-chart-container .command[data-v-eb989946] {\n  width: 30px;\n  height: 30px;\n  flex: 1 1 auto;\n  text-align: center;\n  color: #bbbbbb;\n  background: transparent !important;\n  line-height: 30px;\n  font-size: 16px;\n  border: none;\n  cursor: pointer;\n  z-index: 3;\n}\n.order-chart-container .command[data-v-eb989946]:not(.noaction):hover {\n  background: #2a2e39 !important;\n}\n.order-chart-container .command.noaction[data-v-eb989946] {\n  cursor: unset !important;\n}\n.order-chart-container .order-button[data-v-eb989946] {\n  position: absolute;\n  display: none;\n  padding: 5px;\n  text-align: center;\n  border-radius: 7px;\n  color: black;\n  background: silver;\n  z-index: 3;\n  cursor: pointer;\n}\n.order-chart-container .order-button.entry[data-v-eb989946] {\n  width: 70px;\n  height: 55px;\n  color: white !important;\n}\n.order-chart-container .order-button.tpsl[data-v-eb989946] {\n  width: 60px;\n  height: 50px;\n}\n.order-chart-container .chart-top[data-v-eb989946] {\n  position: absolute;\n  bottom: 29px;\n  right: 55px;\n  border-radius: 50%;\n  border: 1px solid gray;\n  padding-left: 1px;\n  line-height: 22px !important;\n  width: 25px !important;\n  height: 25px !important;\n  font-size: 18px;\n}", ""]);
...
/***/ "./resources/js/views/Trading/OrderChart.vue":
/*!***************************************************!*\
  !*** ./resources/js/views/Trading/OrderChart.vue ***!
  \***************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _OrderChart_vue_vue_type_template_id_eb989946_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./OrderChart.vue?vue&type=template&id=eb989946&scoped=true& */ "./resources/js/views/Trading/OrderChart.vue?vue&type=template&id=eb989946&scoped=true&");
/* harmony import */ var _OrderChart_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./OrderChart.vue?vue&type=script&lang=js& */ "./resources/js/views/Trading/OrderChart.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _OrderChart_vue_vue_type_style_index_0_id_eb989946_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./OrderChart.vue?vue&type=style&index=0&id=eb989946&lang=scss&scoped=true& */ "./resources/js/views/Trading/OrderChart.vue?vue&type=style&index=0&id=eb989946&lang=scss&scoped=true&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _OrderChart_vue_vue_type_template_id_eb989946_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"],
  _OrderChart_vue_vue_type_template_id_eb989946_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  "eb989946",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/Trading/OrderChart.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/views/Trading/OrderChart.vue?vue&type=script&lang=js&":
/*!****************************************************************************!*\
  !*** ./resources/js/views/Trading/OrderChart.vue?vue&type=script&lang=js& ***!
  \****************************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/views/Trading/OrderChart.vue?vue&type=style&index=0&id=eb989946&lang=scss&scoped=true&":
/*!*************************************************************************************************************!*\
  !*** ./resources/js/views/Trading/OrderChart.vue?vue&type=style&index=0&id=eb989946&lang=scss&scoped=true& ***!
  \*************************************************************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_vue_loader_lib_index_js_vue_loader_options_OrderChart_vue_vue_type_style_index_0_id_eb989946_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/style-loader!../../../../node_modules/css-loader!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/src??ref--7-2!../../../../node_modules/sass-loader/dist/cjs.js??ref--7-3!../../../../node_modules/vue-loader/lib??vue-loader-options!./OrderChart.vue?vue&type=style&index=0&id=eb989946&lang=scss&scoped=true& */ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/Trading/OrderChart.vue?vue&type=style&index=0&id=eb989946&lang=scss&scoped=true&");
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_vue_loader_lib_index_js_vue_loader_options_OrderChart_vue_vue_type_style_index_0_id_eb989946_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_vue_loader_lib_index_js_vue_loader_options_OrderChart_vue_vue_type_style_index_0_id_eb989946_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_vue_loader_lib_index_js_vue_loader_options_OrderChart_vue_vue_type_style_index_0_id_eb989946_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_vue_loader_lib_index_js_vue_loader_options_OrderChart_vue_vue_type_style_index_0_id_eb989946_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));


/***/ }),

/***/ "./resources/js/views/Trading/OrderChart.vue?vue&type=template&id=eb989946&scoped=true&":
/*!**********************************************************************************************!*\
  !*** ./resources/js/views/Trading/OrderChart.vue?vue&type=template&id=eb989946&scoped=true& ***!
  \**********************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_OrderChart_vue_vue_type_template_id_eb989946_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib??ref--4-0!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!../../../../node_modules/vue-loader/lib??vue-loader-options!./OrderChart.vue?vue&type=template&id=eb989946&scoped=true& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/Trading/OrderChart.vue?vue&type=template&id=eb989946&scoped=true&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_OrderChart_vue_vue_type_template_id_eb989946_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_OrderChart_vue_vue_type_template_id_eb989946_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
