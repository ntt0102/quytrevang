...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/admin/Settings/Faqs.vue?vue&type=script&lang=js&":
/*!*************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/views/admin/Settings/Faqs.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var devextreme_vue_html_editor__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! devextreme-vue/html-editor */ "./node_modules/devextreme-vue/html-editor.js");
...
/* harmony import */ var _components_Popups_PickImagePopup_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../components/Popups/PickImagePopup.vue */ "./resources/js/components/Popups/PickImagePopup.vue");
/* harmony import */ var _store_modules_Admin_Settings_Faqs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../store/modules/Admin/Settings/Faqs */ "./resources/js/store/modules/Admin/Settings/Faqs.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    DxHtmlEditor: devextreme_vue_html_editor__WEBPACK_IMPORTED_MODULE_3___default.a,
    PickImagePopup: _components_Popups_PickImagePopup_vue__WEBPACK_IMPORTED_MODULE_4__["default"]
  },
  data: function data() {
    return {
      gridData: null,
      validationRules: {
        topic: [{
          type: "required",
          message: this.$t("admin.settings.faqs.topic") + this.$mt.validations.required
        }],
        question: [{
          type: "required",
          message: this.$t("admin.settings.faqs.question") + this.$mt.validations.required
        }],
        answer: [{
          type: "required",
          message: this.$t("admin.settings.faqs.answer") + this.$mt.validations.required
        }]
      }
    };
  },
  beforeCreate: function beforeCreate() {
    this.$store.registerModule("Admin.settings.faqs", _store_modules_Admin_Settings_Faqs__WEBPACK_IMPORTED_MODULE_5__["default"]);
  },
  ...
  computed: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapGetters"])("Admin.settings.faqs", ["faqs"])), {}, {
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])("Admin.settings.faqs", ["fetch", "save", "resetState"])), {}, {
    ...
    onUseHtmlChange: function onUseHtmlChange(e) {
      this.dataGrid.option("editing.form.items[2].editorOptions.value", e.value);
    ...
    onInitNewRow: function onInitNewRow(e) {
      this.dataGrid.option("editing.popup.title", this.$t("admin.settings.faqs.popup.create"));
    },
    onEditingStart: function onEditingStart(e) {
      var isUseHtml = /<\/?[a-z][\s\S]*>/i.test(e.data.answer);
      this.onUseHtmlChange({
        value: isUseHtml
      });
      this.dataGrid.option("editing.popup.title", this.$t("admin.settings.faqs.popup.edit"));
    },
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/admin/Settings/Faqs.vue?vue&type=template&id=6f9e5bcc&scoped=true&":
/*!***********************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/views/admin/Settings/Faqs.vue?vue&type=template&id=6f9e5bcc&scoped=true& ***!
  \***********************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function render() {
  ...
  return _c("div", [_c("DxDataGrid", {
      ...
      editing: {
        ...
        form: {
          ...
          items: [{
            ...
            editorOptions: {
              value: false,
              onValueChanged: _vm.onUseHtmlChange
            },
            label: {
              text: _vm.$t("admin.settings.faqs.useHtml")
            }
          }, {
            visible: true,
            colSpan: 2,
            ...
            editorOptions: {
              ...
              toolbar: {
                items: ["undo", "redo", "separator", "bold", "italic", "strike", "underline", "separator", "alignLeft", "alignCenter", "alignRight", "alignJustify", "separator", "orderedList", "bulletList", "separator", "color", "background", "separator", "link", "image", "separator", "clear", "insertTable"]
              }
            }
          }]
        },
          ...
          attrs: {
            items: [{
              ...
              options: {
                ...
                onClick: function onClick() {
                  _vm.dataGrid.editRow(data.rowIndex);
                }
              }
            }, {
              locateInMenu: "auto",
    ...
    attrs: {
      ...
      caption: _vm.$t("admin.settings.faqs.topic"),
      "validation-rules": _vm.validationRules.topic
    }
  }), _vm._v(" "), _c("DxColumn", {
    attrs: {
      "data-field": "question",
      ...
      caption: _vm.$t("admin.settings.faqs.question"),
      "validation-rules": _vm.validationRules.question
    }
  }), _vm._v(" "), _c("DxColumn", {
    attrs: {
      visible: false,
      ...
      caption: _vm.$t("admin.settings.faqs.answer"),
      "validation-rules": _vm.validationRules.answer
    }
  })], 1), _vm._v(" "), _c("PickImagePopup", {
    ref: "pickImagePopup"
  })], 1);
};
var staticRenderFns = [];
...
var actions = {
  fetch: function fetch(_ref) {
    ...
    return new Promise(function (resolve, reject) {
      axios.get("settings/faqs").then(function (response) {
...
/***/ "./resources/js/views/admin/Settings/Faqs.vue":
/*!****************************************************!*\
  !*** ./resources/js/views/admin/Settings/Faqs.vue ***!
  \****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Faqs_vue_vue_type_template_id_6f9e5bcc_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Faqs.vue?vue&type=template&id=6f9e5bcc&scoped=true& */ "./resources/js/views/admin/Settings/Faqs.vue?vue&type=template&id=6f9e5bcc&scoped=true&");
/* harmony import */ var _Faqs_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Faqs.vue?vue&type=script&lang=js& */ "./resources/js/views/admin/Settings/Faqs.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Faqs_vue_vue_type_template_id_6f9e5bcc_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Faqs_vue_vue_type_template_id_6f9e5bcc_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  "6f9e5bcc",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/admin/Settings/Faqs.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/views/admin/Settings/Faqs.vue?vue&type=script&lang=js&":
/*!*****************************************************************************!*\
  !*** ./resources/js/views/admin/Settings/Faqs.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/views/admin/Settings/Faqs.vue?vue&type=template&id=6f9e5bcc&scoped=true&":
/*!***********************************************************************************************!*\
  !*** ./resources/js/views/admin/Settings/Faqs.vue?vue&type=template&id=6f9e5bcc&scoped=true& ***!
  \***********************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Faqs_vue_vue_type_template_id_6f9e5bcc_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib??ref--4-0!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!../../../../../node_modules/vue-loader/lib??vue-loader-options!./Faqs.vue?vue&type=template&id=6f9e5bcc&scoped=true& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/admin/Settings/Faqs.vue?vue&type=template&id=6f9e5bcc&scoped=true&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Faqs_vue_vue_type_template_id_6f9e5bcc_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Faqs_vue_vue_type_template_id_6f9e5bcc_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
