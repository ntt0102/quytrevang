...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    setTimeout(function () {
      ...
      _this2.series.volume = _this2.chart.addHistogramSeries({
        priceScaleId: "volume",
        priceFormat: {
          type: "volume"
        },
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapActions"])("User.orderChart", ["getChartData", "getConfig"])), {}, {
          ...
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _this3.spinnerShow = true; // if (loadWhitespace) {
    ...
    generateChartData: function generateChartData(r, item) {
      if (this.checkDuplicateTime(r, item.time)) {
        ...
        var upColor = "rgba(".concat(this.UP_COLOR, ",0.35)");
        var downColor = "rgba(".concat(this.DOWN_COLOR, ",0.35)");
        ...
        _c("div", { staticClass: "order-chart-container" }, [
          ...
          _c("div", { staticClass: "area", attrs: { id: "dataAreaDiv" } }, [
            ...
            _c(
              ...
              _vm._l(_vm.chartTypes, function(chartType) {
                return _c(
                  ...
                  {
                    key: chartType.value,
                    domProps: { value: chartType.value }
                  },
                  [_vm._v(_vm._s(chartType.text))]
                )
              }),
              0
            ),
              ...
              "select",
              {
                ...
                on: {
                  change: function($event) {
                    ...
                    _vm.timeFrame = $event.target.multiple
                      ? $$selectedVal
                      : $$selectedVal[0]
                  }
                }
              },
              _vm._l(_vm.timeFrames, function(timeFrame) {
                return _c(
                  "option",
                  {
                    key: timeFrame.value,
                    domProps: { value: timeFrame.value }
                  },
                  [_vm._v(_vm._s(timeFrame.text))]
                )
              }),
              0
            ),
            ...
            _c("div", {
              ...
              attrs: { id: "dataAreaDiv" }
            }),
            _vm._v(" "),
            _c("div", {
              staticClass: "command  far fa-trash",
              attrs: { id: "dataAreaDiv" }
            })
          ]),
          _vm._v(" "),
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "area", attrs: { id: "toolAreaDiv" } }, [
      ...
      _vm._v(" "),
      _c("div", { staticClass: "command far fa-map-marker-check" }),
      _vm._v(" "),
      _c("div", { staticClass: "command far fa-arrows-v" }),
      _vm._v(" "),
      _c("div", { staticClass: "command far fa-bell-on" })
    ])
  }
]
...
var actions = {
  getChartData: function getChartData(_ref, chartDate) {
    ...
    return new Promise(function (resolve, reject) {
      axios.post("order-chart/chart-data", {
        date: chartDate
      }, {
        noLoading: true
  ...
  getConfig: function getConfig(_ref2) {
    ...
    return new Promise(function (resolve, reject) {
      axios.post("order-chart/get-config").then(function (response) {
        // console.log(response.data);
  ...
  validateDuplicateUser: function validateDuplicateUser(_ref3, param) {
  ...
  getPlans: function getPlans(_ref5) {
  ...
  savePlans: function savePlans(_ref6, param) {
