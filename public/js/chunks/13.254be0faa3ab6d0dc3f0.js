...
!(function webpackMissingModule() { var e = new Error("Cannot find module '../Pdfs/Index.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    Pdf: !(function webpackMissingModule() { var e = new Error("Cannot find module '../Pdfs/Index.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
  },
  data: function data() {
    return {
      refreshKey: 0,
...
throw new Error("Module build failed (from ./node_modules/sass-loader/dist/cjs.js):\nSassError: Can't find stylesheet to import.\n  ╷\n2 │ @import \"../../../sass/variables.scss\";\r\n  │         ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  ╵\n  C:\\xampp\\htdocs\\quytrevang\\resources\\js\\views\\admin\\User\\ConfirmUserPopup.vue 2:9  root stylesheet");
