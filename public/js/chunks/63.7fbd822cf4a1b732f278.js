...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  beforeCreate: function beforeCreate() {
    this.$store.registerModule("Admin.orderChart", _store_modules_Admin_OrderChart__WEBPACK_IMPORTED_MODULE_2__["default"]);
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])("Admin.orderChart", ["getChartData", "getStatus", "getConfig", "executeOrder"])), {}, {
    ...
    cancelOrderClick: function cancelOrderClick() {
      var _this7 = this;
      var result = Object(devextreme_ui_dialog__WEBPACK_IMPORTED_MODULE_3__["confirm"])(this.$t("admin.orderChart.cancelOrder"), this.$t("admin.orderChart.cancelConfirm"));
    ...
    entryOrderClick: function entryOrderClick() {
      ...
      if (this.inSession(CURRENT_SEC)) {
        if (CURRENT_SEC < TIME.ATO) {
          var result = Object(devextreme_ui_dialog__WEBPACK_IMPORTED_MODULE_3__["confirm"])(this.$t("admin.orderChart.atoOrder"), this.$t("admin.orderChart.cancelConfirm"));
          result.then(function (dialogResult) {
            if (dialogResult) {
              _this8.executeOrder({
                action: "exit",
          ...
          var _result = Object(devextreme_ui_dialog__WEBPACK_IMPORTED_MODULE_3__["confirm"])(this.$t("admin.orderChart.atcOrder"), this.$t("admin.orderChart.cancelConfirm"));
