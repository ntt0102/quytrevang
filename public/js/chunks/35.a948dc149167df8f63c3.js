...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])("Settings", ["fetchLog"])), {}, {
    showProperties: function showProperties(properties) {
      ...
      this.$bus.emit("checkPin", function () {
        ...
        Object(devextreme_ui_dialog__WEBPACK_IMPORTED_MODULE_2__["alert"])("<pre>".concat(_this2.syntaxHighlight(html), "</pre>"), _this2.$t("settings.log.propertiesTitle"));
      });
    },
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }, [_vm._v("\n        " + _vm._s(_vm.$t("settings.log.title")) + "\n    ")]), _vm._v(" "), _c("div", {
          ...
          attrs: {
            items: [{
              ...
              options: {
                type: "default",
                icon: "info",
                hint: _vm.$t("settings.log.propertiesBtn"),
                text: _vm.$t("settings.log.propertiesBtn"),
    ...
    attrs: {
      ...
      "data-type": "date",
      caption: _vm.$t("settings.log.createdAt")
    }
  }), _vm._v(" "), _c("DxColumn", {
    attrs: {
      "data-field": "causer",
      caption: _vm.$t("settings.log.causer")
    }
  }), _vm._v(" "), _c("DxColumn", {
    attrs: {
      "data-field": "subject",
      caption: _vm.$t("settings.log.subject")
    }
  }), _vm._v(" "), _c("DxColumn", {
    attrs: {
      "data-field": "description",
      caption: _vm.$t("settings.log.description")
    }
  })], 1)], 1)])]);
};
var staticRenderFns = [];
