...
/* harmony import */ var devextreme_vue_file_manager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! devextreme-vue/file-manager */ "./node_modules/devextreme-vue/file-manager.js");
/* harmony import */ var devextreme_vue_file_manager__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(devextreme_vue_file_manager__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var devextreme_file_management_custom_provider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! devextreme/file_management/custom_provider */ "./node_modules/devextreme/esm/file_management/custom_provider.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    DxFileManager: devextreme_vue_file_manager__WEBPACK_IMPORTED_MODULE_0__["DxFileManager"]
  },
  data: function data() {
    return {
      fileSystemProvider: new devextreme_file_management_custom_provider__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  methods: {
    ...
    copyUrl: function copyUrl() {
      ...
      if (items.length > 1) this.$toasted.info(this.$t("settings.files.messages.multiFile"));else if (items[0].isDirectory) this.$toasted.info(this.$t("settings.files.messages.notIsFile"));else {
        var text = "".concat(window.baseURL, "/storage/").concat(this.clientPath, "/").concat(items[0].path);
        navigator.clipboard.writeText(text).then(function () {
          _this8.$toasted.success(_this8.$t("settings.files.messages.copiedUrl"));
          _this8.$emit("copiedUrl", text);
        }, function (err) {
          return _this8.$toasted.error(_this8.$t("settings.files.messages.notCopiedUrl") + "<br>ERROR: " + err);
        });
      }
    },
    onSelectedFileOpened: function onSelectedFileOpened(_ref) {
      ...
      } else this.$toasted.info(this.$t("settings.files.messages.notIsImage"));
    },
    ...
    attrs: {
      ...
      toolbar: {
        fileSelectionItems: [{
          widget: "dxButton",
          options: {
            text: _vm.$t("settings.files.copyUrl"),
            hint: _vm.$t("settings.files.copyUrl"),
            icon: "link"
          },
          location: "before",
          onClick: _vm.copyUrl
        }, "separator", "move", "copy", "rename", "separator", "delete", "clearSelection"]
      }
    },
    on: {
...
/* empty/unused harmony star reexport *//* harmony import */ var _FileManager_vue_vue_type_style_index_0_id_6a1d18f6_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./FileManager.vue?vue&type=style&index=0&id=6a1d18f6&lang=scss& */ "./resources/js/components/FileManager.vue?vue&type=style&index=0&id=6a1d18f6&lang=scss&");
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_FileManager_vue_vue_type_template_id_6a1d18f6___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_FileManager_vue_vue_type_template_id_6a1d18f6___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
