...
// self.bufferEncode = encoderInstance.encode.bind(encoderInstance);
self.bufferDecode = decoderInstance.decode.bind(decoderInstance);
// self.bufferWrite = q.write;
self.bufferParse = q.parse;
