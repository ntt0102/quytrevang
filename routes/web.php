...
Route::get('test', function () {
    ...
    $payload = (object)['symbol' => 'ACB', 'from' => 1637798400, 'to' => 1683158400, 'timeframe' => 'D', 'name' => 'hose', 'kind' => 'f_bottom'];
    // $s = app(\App\Services\Trading\StockService::class)->getDataForeign($payload)['f'];
